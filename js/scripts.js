    ...
    success: function (data) {
      ...
      data.forEach((item) => {
        ...
        <tr>
          ...
          <td>${item.zipCode}</td>
        <td>
            <button id="#check" onclick="green()">✔️</button>
            <button id="#remove" onclick="showModal()">🗑️</button>
            <button id="undo" onclick="undo()" ↩>↩️</button>
          </td>
          </tr>
        ...
        let htmlt = `
          <div class="row mb-4 d-flex justify-content-between align-items-center">
            ...
            <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
              <select class="form-select form-select-sm sel1">
            ...
            <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
              <h6 class="total-price mb-0">${price}</h6> <!-- Using the 'price' variable here -->
            </div>
